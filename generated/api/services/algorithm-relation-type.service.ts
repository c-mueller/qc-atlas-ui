...
export class AlgorithmRelationTypeService extends BaseService {
   ...
   */
  static readonly GetAlgoRelationTypeByIdPath = '/v1/algorithm-relation-types/{id}';
   ...
   */
  static readonly UpdateAlgoRelationTypePath = '/v1/algorithm-relation-types/{id}';
   ...
   */
  static readonly DeleteAlgoRelationTypePath = '/v1/algorithm-relation-types/{id}';
