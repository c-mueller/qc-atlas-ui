...
export class ApplicationAreasService extends BaseService {
  ...
  getApplicationAreas1$Response(params?: {
  ...
  }): Observable<StrictHttpResponse<{ '_embedded'?: { 'applicationAreaDtoes'?: Array<EntityModelApplicationAreaDto> }, 'page'?: PageMetadata }>> {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<{ '_embedded'?: { 'applicationAreaDtoes'?: Array<EntityModelApplicationAreaDto> }, 'page'?: PageMetadata }>;
      })
    );
  }
  ...
  }): Observable<{ '_embedded'?: { 'applicationAreaDtoes'?: Array<EntityModelApplicationAreaDto> }, 'page'?: PageMetadata }> {

    return this.getApplicationAreas1$Response(params).pipe(
      map((r: StrictHttpResponse<{ '_embedded'?: { 'applicationAreaDtoes'?: Array<EntityModelApplicationAreaDto> }, 'page'?: PageMetadata }>) => r.body as { '_embedded'?: { 'applicationAreaDtoes'?: Array<EntityModelApplicationAreaDto> }, 'page'?: PageMetadata })
    );
  }
